...
<body class="container">
    ...
    <form action="cadPessoa.php" method="post">
        ...
        <div class="form-group">
            <label for="exampleInputPassword1">Tipo de Acesso</label>
            <input type="Text" class="form-control" id="exampleInputPassword1" placeholder="Tipo de Acesso A-V-E" name="tipoDeAcesso">
        </div>
